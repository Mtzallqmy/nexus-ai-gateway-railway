...
export default function ProfilePage() {
  ...
  const [email, setEmail] = useState(user?.email ?? "sarah.chen@moataz.ai");
  const [bio, setBio] = useState("Principal AI engineer leading the Moataz gateway team. Passionate about making AI accessible to every developer.");
